...
file.in.data <- "pilotExp_rawData.csv"
...
save(data,file = "pilotExp_processedData.RData")
...
write.csv(data.frame(subj_idx=data$ID,
                     ...
                     rt=data$RT.raw/1000),"pilotExp_forHDDM_desCode.csv",row.names=FALSE)
...
write.csv(data.frame(subj_idx=data$ID,
                     ...
                     rt=data$RT.raw/1000),"pilotExp_forHDDM_facCode.csv",row.names=FALSE)
